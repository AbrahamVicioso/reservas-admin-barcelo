...
export const Input: React.FC<InputProps> = ({ label, error, className = '', ...props }) => {
  return (
    <div className="w-full">
      ...
      <input
        className={`w-full px-4 py-2.5 border rounded-md focus:ring-2 focus:ring-primary-400/20 focus:border-primary-500 transition-all font-light text-sm placeholder:text-gray-400/60 ${
